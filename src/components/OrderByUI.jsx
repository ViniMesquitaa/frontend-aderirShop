    ...
    <div className="flex items-center justify-center w-full sm:w-auto">
      <div className="relative w-full sm:w-60">
        ...
        <select
          id="orderBy"
          name="orderBy"
          className="w-full rounded-2xl border border-gray-300 bg-white py-2 pl-10 pr-3 shadow-sm focus:border-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-300 transition-all text-[15px] font-medium"
        >
